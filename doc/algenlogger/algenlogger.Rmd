...
## Technik
Als technische Bauteile wurden handlesübliche sowie preisgünstige Geräte verwendet. Auf dem Steckbrett unten zeigt die Anordnung dieser.
...
Die Step-Down-Module transferieren die Netzteilspannung in die jeweils benötigte Spannung. Somit wurde den LED-Streifen mit dem rechten Modul eine Spannung von ca. 18V bereitgestellt. Die restlichen Bauteile wurden mit  7,75V betrieben.

Mit Fritzing wurde die Steckbrettanordnung digitalisiert, sodass bereits fertig verdrahtete Steckbretter bestellt werden könnten. In diesem Fall spart man sich das zeitintensive Verdrahten.   

![Schaltplan (erstellt mit fritzing)](Hauptsteckbrett_Steckplatine_fritzing.png) 
